...
Problemet er da at _alle_ *div* endres iht. dette, om man ønsker det eller ikke. Man kan derfor innføre sin egen *div*, f.eks. *info* ved CLASS-konstruksjonen i HTML
